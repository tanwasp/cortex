...
def predict(args):
    ...
    tokenizer, model, image_processor, context_len = load_pretrained_model(model_path, args.model_base, model_name, device="mps", trust_remote_code=True,)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model-path", type=str, default="~/.cache/huggingface/hub/models--apple--FastVLM-0.5B/snapshots/16375720c2d673fa583e57e9876afde27549c7d0")
